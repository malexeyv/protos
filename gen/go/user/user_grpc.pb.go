...
type UserClient interface {
	...
	GetByEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error)
}
...
func (c *userClient) GetByEmail(ctx context.Context, in *EmailRequest, opts ...grpc.CallOption) (*EmailResponse, error) {
...
type UserServer interface {
	...
	GetByEmail(context.Context, *EmailRequest) (*EmailResponse, error)
...
func (UnimplementedUserServer) GetByEmail(context.Context, *EmailRequest) (*EmailResponse, error) {
...
func _User_GetByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetByEmail(ctx, req.(*EmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
